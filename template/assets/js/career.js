...
document.addEventListener("DOMContentLoaded", function () {
  const contentContainerEL = document.getElementById("career-content");
  const contentTextEL = document.querySelectorAll(".career-content-text");
...
jQuery(function ($) {
  if ($("#career").length) {
    ...
    //CONTROLS
    var slideButtonNext = _this.find(".career-swiper-button-next")[0],
      slideButtonPrev = _this.find(".career-swiper-button-prev")[0];
